...
const questions = [
    ...
    {
      question:
        'In 1995, this band\'s breakthrough album, "Dookie", won the Grammy for Best Alternative Music Album.',
      answers: [
    ...
    {
      question:
        'Sometimes, it\'s the saddest incidents that make for the most amazing of songs. Name the band who turned a suicide tragedy into "Bro Hymn."',
      answers: [
    ...
    {
      question:
        "Tim Armstrong & Lars Frederiksen are singers of this famous punk band.",
      answers: [
    ...
    {
      question:
        'This band was formed by Andy Outbreak and Eric Ozenne and their last album is titled "The Butterfly Collection."',
      answers: [
        { text: "Rancid", correct: false },
    ...
    {
      question:
        "This supergroup features members from Leftover Crack, Ensign, & The Ergs.",
      answers: [
    ...
    {
      question:
        'The singer from this band wrote a memoir titled "Tranny: Confessions of Punk Rock Most Infamous Anarchist Sellout."',
      answers: [
        { text: "Rancid", correct: false },
        { text: "Bad Religion", correct: false },
   ...
   // increment score - right and wrong answers
